           ...
           <div className='mx-auto max-w-[1000px]  mt-24 '>
            <div className='  flex text-white text-center '>
                ...
                <div className='relative'>
                    ...
                    <input type="email" name="email" placeholder='Email' className='w-full py-4 text-black  outline-none bg-slate-100  rounded-lg placeholder:text-slate-400 pl-12'/>
                </div>
                <div className='relative mt-9 '>
                    <div className='flex gap-2 items-center absolute top-[14px] left-[20px]'>
                         <RiLockPasswordFill className=' text-xl font-bold text-slate-600 mt-1'/>
                    </div>
                    <input type="password" name="password" placeholder='Password' className='w-full py-4  text-black outline-none bg-slate-100  rounded-lg   placeholder:text-slate-400 pl-12'/>
                </div>
               <button type='submit' className=' mx-auto mt-7 px-16 block uppercase rounded-full py-4 text-white bg-gradient-to-tl from-[#448c7f] to-[50%] to-[#9ad9cc] from-[50%]'>sign in</button>
            </form>
