           ...
           <div className='mx-auto max-w-[1000px]  mt-24 '>
            <div className='  flex text-white text-center '>
                ...
                <div className='relative'>
                    ...
                    <input type="text" name="name" placeholder='Full Name' className='w-full py-4 bg-slate-100 text-black pl-12 rounded-lg placeholder:text-slate-400'/>
                </div>
                <div className='relative mt-9'>
                    <div className=' absolute top-[15px] left-[20px]'>
                         <PiEnvelopeSimpleThin className=' text-xl font-bold text-slate-600 mt-1'/>
                    </div>
                    <input type="email" name="email" placeholder='Email' className='w-full py-4 bg-slate-100 text-black pl-12 rounded-lg placeholder:text-slate-400'/>
                </div>
                <div className='relative mt-9 '>
                    <div className=' absolute top-[15px] left-[20px]'>
                         <RiLockPasswordFill className=' text-xl font-bold text-slate-600 mt-1'/>
                    </div>
                    <input type="password" name="password" placeholder='Password' className='w-full py-4 bg-slate-100 text-black pl-12 rounded-lg  placeholder:text-slate-400'/>
                </div>
               <button type='submit' className=' mx-auto mt-7 px-16 block uppercase rounded-full py-4 text-white bg-gradient-to-tl from-[#448c7f] to-[50%] to-[#9ad9cc] from-[50%]'>sign up</button>
            </form>
